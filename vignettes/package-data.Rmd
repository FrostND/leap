...
The starting point for most leap workflows is a person-period data set in which each row represents a treatment session for a client. A typical data set might contain the following:
